...
<form action="/install/3" class="data-form" method="post">
	...
	<div class="submit" style="margin-top:20px;">
		...
		<img src="img/ajax.gif" alt="<?php echo app::lang('server_response') ?>" style="margin-right:5px;display:none;" align="bottom" id="ajax_indication">
...
<script src="testConnect.js" type="text/javascript"></script>