...
var DatePicker = new Class({
    ...
    onFocus: function(original_input, visual_input) {
        ...
        if(!Browser.Engine.trident){
          ...
          //alert('d.top='+d.top+"\r\nd.height="+d.height+"\r\nthis.options.positionOffset.y="+this.options.positionOffset.y+"\r\nwindow.getScroll().y="+window.getScroll().y+"\r\nwindow.getPosition().y="+window.getPosition().y);
          this.show({ left: d.left + this.options.positionOffset.x, top: d.top + d.height + window.getScroll().y }, init_visual_date);
        }
