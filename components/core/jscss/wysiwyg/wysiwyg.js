...
var WYSIWYG = {
    ...
    initialize: function() {
        if (!this.language) {
            ...
            CKEDITOR.config.filebrowserUploadUrl = SITE_URL + 'components/core/jscss/wysiwyg/upload.php';
            CKEDITOR.config.filebrowserBrowseUrl = SITE_URL + 'components/core/jscss/wysiwyg/browser.php';
        }
    },
