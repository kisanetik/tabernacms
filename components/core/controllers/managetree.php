...
class controller_core_managetree extends rad_controller
{
    ...
    {
        $this->defNewItem = new struct_coremenus_tree;
            ...
            if($tre_id) {
                ...
                if(count($_FILES)) {
                    if(isset($_FILES['tre_image']) and ($_FILES['tre_image']['size']>0) and ($_FILES['tre_image']['error']!=4) ) {
                        ...
                        move_uploaded_file($_FILES['tre_image']['tmp_name'], COREMENUS_IMG_PATH.$item->tre_image);
                    }
                    if(isset($_FILES['tre_menuimage']) and ($_FILES['tre_menuimage']['size']>0) and ($_FILES['tre_menuimage']['error']!=4) ) {
                        ...
                        move_uploaded_file($_FILES['tre_menuimage']['tmp_name'], COREMENUS_IMG_PATH.$item->tre_image_menu);
                    }
                    if(isset($_FILES['tre_menuimagea']) and ($_FILES['tre_menuimagea']['size']>0) and ($_FILES['tre_menuimagea']['error']!=4) ) {
                        ...
                        move_uploaded_file($_FILES['tre_menuimagea']['tmp_name'], COREMENUS_IMG_PATH.$item->tre_image_menu_a);
                    }
                }
                $rows = $model->updateItem($item);
            } else {
