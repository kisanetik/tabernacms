 ...
 */
var WYSIWYG_UPLOAD_URL = '{url href="action=upload"}';
var WYSIWYG_BROWSE_URL = '{url href="action=browse"}';
...
var WYSIWYG = {
    ...
    initialize: function() {
        if (!this.language) {
            ...
            //TODO: move this PHP connectors out of the component folder so it would be accessible via web
            CKEDITOR.config.filebrowserUploadUrl = WYSIWYG_UPLOAD_URL;
            CKEDITOR.config.filebrowserBrowseUrl = WYSIWYG_BROWSE_URL;
        }
    },
