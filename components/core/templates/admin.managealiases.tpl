{strip}
{if isset($action) and ($action eq 'saveeditscript' or $action eq 'save' or $action eq 'applyinc' or $action eq 'delinc' or $action eq 'addWinclude' or $action eq 'saveconfinclude' or $action eq 'getcontrollerjs' or $action eq 'savedescription' or $action eq 'createtheme' or $action eq 'deletetheme') }
