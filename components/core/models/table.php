 ...
 * @package RADCMS
 */
class model_core_table extends rad_model
{
     ...
     * @param string $module name of the component
     * @return model_core_table struct instance
     */
    function __construct($tablename, $module = 'core')
    {
        $this->_tablename = RAD . $tablename;
        $this->_module = $module;
        $this->_struct_name = "struct_{$module}_{$tablename}";
    }

    /**
     * gets struct instance
     * @param string $tablename name of the table (without prefix)
     * @param string $module name of the component
     * @return model_core_table struct instance
     * @todo This method should be removed after dropping PHP 5.3- support (in PHP 5.4 it would be obsolete).
     */
    public static function getInstance($tablename, $module = 'core')
    {
        return new self($tablename, $module);
    }
