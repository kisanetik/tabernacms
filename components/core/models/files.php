 ...
 */
class model_core_files extends rad_model
{
     ...
     * Uploads the file
     * @example
     *         model_core_files::uploadFile($_FILE['fieldName'], 'tracker', $item->tra_id, 700);
     * @param array $file
     * @param string $module
     * @param integer $itemId
     * @param integer $access
     * @return struct_core_files
     */
    /* TODO:
    public function uploadFile($file, $module, $itemId=0, $access = 1000)
    {
        ...
        $item = new struct_core_files(array(
