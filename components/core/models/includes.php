<?php
class model_core_includes extends rad_model
{
    function getItem($id)
    {
        ...
        if(!$id){
            ...
            $table = new model_core_table('includes_in_aliases');
    ...
    function insertItem(struct_core_includes_in_aliases $struct)
    {
     ...
     *
     * @param struct_core_includes_in_aliases $struct
     * 
     * @return integer number of deleted records
     */
    function deleteItem(struct_core_includes_in_aliases $struct)
    {
        return $this->delete_struct($struct, RAD.'includes_in_aliases');
    }
    
    function updateItem(struct_core_includes_in_aliases $struct)
    {
