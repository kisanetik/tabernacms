{strip}
{url href="alias=SITE_ALIASXML&action=getjs_addedit" type="js"}
                    ...
                    <div class="tb_line_ico">
                        ...
                        <tr>
                            ...
                            <a href="javascript:RADAddEditVotes.cancelClick();">
                                <img src="{url type="image" module="core" preset="original" file="backend/arrow_undo.png"}" alt="" width="33" height="33" border="0" class="img" alt="{lang code='-cancel' ucf=true}" title="{lang code='-cancel' ucf=true}" />
                        ...
                        <tr>
                            ...
                            <a href="javascript:RADAddEditVotes.deleteClick();">
                                <img src="{url type="image" module="core" preset="original" file="backend/icons/ico_delete.gif"}" alt="" width="33" height="33" border="0" class="img" alt="{lang code='-delete' ucf=true}" title="{lang code='-delete' ucf=true}" />
                        ...
                        <tr>
                            ...
                            <a href="javascript:RADAddEditVotes.applyClick();">
                                <img src="{url type="image" module="core" preset="original" file="backend/accept.png"}" alt="" width="33" height="33" border="0" class="img" alt="{lang code='-apply' ucf=true}" title="{lang code='-apply' ucf=true}" />
                        ...
                        <tr>
                            ...
                            <a href="javascript:RADAddEditVotes.saveClick();">
                                <img src="{url type="image" module="core" preset="original" file="backend/disk.png"}" alt="" width="33" height="33" border="0" class="img" alt="{lang code='-save' ucf=true}" title="{lang code='-save' ucf=true}" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="vt_treid" id="vt_treid">
                                        ...
                                        {/if}
                                        {radinclude module="coreothers" file="admin.managevotes/panels/tree_recursy.tpl" elements=$categories selected=$selected nbsp=3}
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                              ...
                                              <div class="hb_inner">
                                                  ...
                                                  <tr>
                                                      ...
                                                      <a href="javascript:RADVotesQuestions.refresh();">
                                                          <img src="{url type="image" module="core" preset="original" file="backend/arrow_rotate_clockwise.png"}" alt="" width="33" height="33" border="0" class="img" alt="{lang code='-apply' ucf=true}" title="{lang code='-apply' ucf=true}" />
                                                  ...
                                                  <tr>
                                                      ...
                                                      <a href="javascript:RADVotesQuestions.saveAnswerDialog();">
                                                          <img src="{url type="image" module="core" preset="original" file="backend/add.png"}" alt="" width="33" height="33" border="0" class="img" alt="{lang code='-apply' ucf=true}" title="{lang code='-apply' ucf=true}" />
