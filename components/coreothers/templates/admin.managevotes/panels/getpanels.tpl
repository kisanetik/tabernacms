                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADVotes.refresh();">
                                                    <img src="{url type="image" module="core" preset="original" file="backend/arrow_rotate_clockwise.png"}" width="30" height="30" border="0" alt="{lang code='-add'}" title="{lang code='-add'}" />
