                                    ...
                                    *}
                                    ...
                                    <tr>
                                        ...
                                        <a href="javascript:RADMailSubscribes.applyClick();">
                                            <img src="{url type="image" module="core" preset="original" file="backend/accept.png"}" alt="" width="33" height="33" border="0" class="img" alt="{lang code="-submit"}" title="{lang code="-submit"}" />
