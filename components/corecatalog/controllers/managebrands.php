 ...
 *
 */
class controller_corecatalog_managebrands extends rad_controller
{
    ...
    function editFormBrand()
    {
        ...
        if($this->request('rcb_id')) {
            $item = rad_instances::get('model_corecatalog_brands')->getItem((int)$this->request('rcb_id'));
            $this->setVar('item',$item);
        } else {
            $this->setVar('item', new struct_corecatalog_cat_brands());
        }
    }
    ...
    function saveBrand()
    {
        if($this->request('hash') == $this->hash()) {
            ...
            if($this->request('action_sub')=='edit') {
                ...
                $brand_item = new struct_corecatalog_cat_brands( $this->getAllRequest() );
            }
