{strip}
{url module="coreresource" file="radcomments.js" type="js"}
{wysiwyg}
<div class="commentsWrapper">
    ...
    <div id="comments_loader">
        <img src="{url type="image" preset="original" module="core" file="mootree/mootree_loader.gif"}" alt="{lang code="-loading" ucf=true}" title="{lang code="-loading" ucf=true}" border="0" />
    </div>
