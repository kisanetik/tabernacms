        ...
        <tr>
            ...
            <td>
                <a href="javascript:RADComments.change({$item->rcm_id});">
                    <img src="{url type="image" module="core" preset="original" file="backend/billiard_marker.png"}" alt="{lang code="-edit" ucf=true}" border="0" />
                </a>
                <a href="javascript:RADComments.delItem({$item->rcm_id})">
                    <img src="{url type="image" module="core" preset="original" file="backend/icons/cross.png"}" alt="{lang code="-delete" ucf=true}" border="0" />
                </a>
            </td>
        </tr>
    {/foreach}
