                                        ...
                                        {foreach from=$items item=article name=article_a}
                                            <li>
                                                ...
                                                <div class="article_image">
                                                    <a title="{$article->art_title}" href="{url href="t=`$article->art_title|@urlencode`&a=`$article->art_id`"}">
                                                        <img src="{url module="corearticles" file="articles/`$article->art_img`" type="image" preset="article_xlarge"}" width="160" height="120" alt="{$article->art_title|replace:'"':'&quot;'}" title="{$article->art_title|replace:'"':'&quot;'}" border="0"  class="imageborder" />
                                                    </a>
                                                </div>
                                                {/if}
