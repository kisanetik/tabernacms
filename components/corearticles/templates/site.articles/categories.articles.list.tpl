...
<div class="article_list">
    ...
    <div class="article_item">
        ...
        <div class="article_image">
            <a href="{url href="p=$artid"}">
                <img src="{url module="corearticles" file="articles/`$article->art_img`" type="image" preset="article_xlarge"}" alt="{$article->art_title|replace:'"':'&quot;'}" title="{$art->art_title|replace:'"':'&quot;'}" border="0"  class="imageborder" />
            </a>
        </div>
        {/if}
