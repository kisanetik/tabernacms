...
{url module="core" file="datepicker/datepicker.js" type="js"}
{url module="core" file="datepicker/datepicker.css" type="css"}
{url module="core" file="datepicker/datepicker_vista.css" type="css"}
                                ...
                                <div class="group_box margin_bottom">
                                    ...
                                    <div class="kord_cont">
                                        <div id="tables_images">
                                            {if $item->nw_img}
                                            <div id="img_cat">
                                                <img src="{url module="corearticles" file="news/`$item->nw_img`" type="image" preset="article_medium"}" border="0" />
                                                <br />
                                                <label>
