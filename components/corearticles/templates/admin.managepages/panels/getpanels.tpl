                                                ...
                                                <form method="post" id="searchPagesForm" action="{const SITE_URL}{const SITE_ALIAS}/action/search/" onsubmit="return false;">
                                                    <div>
                                                        ...
                                                        <div style="float:left;margin-top:15px;">
                                                            <a><input type="image" src="{url type="image" module="core" preset="original" file="backend/zoom.png"}" alt="{lang code='-submit'}" title="{lang code='-submit'}"  onclick="RADPages.searchClick();" /></a>
                                                        </div>
                                                    </div>
                                                </form>
                                           </td>
