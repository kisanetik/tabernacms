...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    dir="ltr">
<body>
{url type="js" module="core" file="main.js"}
...
if(window.parent.$('tree_img')) {literal} { {/literal}
    window.parent.$('tree_img').src='{url module="coremenus" file="`$new_fn`" type="image" preset="tree_wide"}';
{literal}
}else{
{/literal}
    var s= '<img src="{url module="coremenus" file="`$new_fn`" type="image" preset="tree_wide"}" border="0" />';
