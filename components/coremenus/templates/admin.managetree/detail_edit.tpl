                                    ...
                                    <div class="kord_cont">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                {if $params->showsectionimage}
                                                    ...
                                                    <tr><td colspan="2">
                                                        <img src="{url module="coremenus" file="`$item->tre_image`" type="image" preset="box_small"}" alt="{lang code='imagesection.menus.text'}" title="{lang code='imagesection.menus.text'}" border="0" />
                                                ...
                                                {if $params->showmenuimage}
                                                    ...
                                                    <tr><td colspan="2">
                                                        <img src="{url module="coremenus" file="`$item->tre_image_menu`" type="image" preset="box_small"}" alt="{lang code='imagemenu.menus.text'}" title="{lang code='imagemenu.menus.text'}" border="0" />
                                                ...
                                                {if $params->showmenuactivimage}
                                                    ...
                                                    <tr><td colspan="2">
                                                        <img src="{url module="coremenus" file="`$item->tre_image_menu_a`" type="image" preset="box_small"}" alt="{lang code='imagemenu.menus.text'}" title="{lang code='imagemenu.menus.text'}" border="0" />
