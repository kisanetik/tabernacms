                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADTree.addClick();">
                                                    <img src="{url type="image" module="core" preset="original" file="backend/add.png"}" alt="" width="30" height="30" border="0" alt="{lang code='-add'}" title="{lang code='-add'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADTree.editClick();">
                                                    <img src="{url type="image" module="core" preset="original" file="backend/pencil.png"}" alt="" width="30" height="30" border="0" alt="{lang code='-edit'}" title="{lang code='-edit'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADTree.cancelClick();">
                                                    <img class="img" src="{url type="image" module="core" preset="original" file="backend/arrow_undo.png"}" alt="" width="30" height="30" border="0" alt="{lang code='-cancel' ucf=true}" title="{lang code='-cancel' ucf=true}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADTree.deleteClick();">
                                                    <img src="{url type="image" module="core" preset="original" file="backend/icons/ico_delete.gif"}" alt="" width="30" height="30" border="0" alt="{lang code='-delete'}" title="{lang code='-delete'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADTree.saveClick();">
                                                    <img src="{url type="image" module="core" preset="original" file="backend/disk.png"}" alt="" width="30" height="30" border="0" alt="{lang code='-save' ucf=true}" title="{lang code='-save' ucf=true}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADTree.editDetailClick();">
                                                    <img class="img" src="{url type="image" module="core" preset="original" file="backend/draw_points.png"}" alt="" width="30" height="30" border="0" alt="{lang code='editdetail.menus.button'}" title="{lang code='editdetail.menus.button'}" />
