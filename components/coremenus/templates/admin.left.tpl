...
<div id="show_LFM_btn" style="display:none;cursor:pointer;">
    <div id="hide_lmenu_btn" style="width:15px;" onclick="showLFM();">
        <img src="{url type="image" module="core" preset="original" file="backend/arrow-show.png"}" border="0" alt="{lang code='show.leftmenu.link'}" title="{lang code='show.leftmenu.link' ucf=true}" />
    </div>
                                            ...
                                            <div>
                                                <div>
                                                    <div>
                                                        ...
                                                        <span{if !empty($item->tre_image)} style="background-image: url('{url module="coremenus" file="`$item->tre_image`" type="image" preset="productstree"}'); background-position: 5px 50%; background-repeat: no-repeat;"{/if}>{$item->tre_name}</span></a>
