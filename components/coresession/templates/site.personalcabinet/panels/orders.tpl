...
{foreach $orderInfo->order_positions as $op name=products}
        <div class="field_goods{if $smarty.foreach.products.last} bordnn{/if}">
            <div class="col1 col">
                <div class="product">
                    <img src="{if $op->photo neq ''}{url module="corecatalog" file="`$op->photo`" type="image" preset="orderposition_small"}{else}{url module="core" file="des/No_image_available.png" type="image" preset="original"}{/if}" width="27" height="45" alt="{$op->orp_name}" />
