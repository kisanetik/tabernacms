	                ...
	                var row = new Element('tr'),
	                    ...
	                    td3 = new Element('td', {
	                        html: '<div class="actions">'
	                        	 +'<img class="undo" src="' + SITE_URL + 'img/backend/icons/arrow_undo.png" width="16" height="16" border="0" alt="' + STR_DELETE + '" title="' + STR_DELETE + '" style="display: none" onclick="RADTranslationLine.clickUndo(event)"/>'
	                        	 +'<img class="save" src="' + SITE_URL + 'img/backend/icons/disk.png" width="16" height="16" border="0" alt="' + STR_DELETE + '" title="' + STR_DELETE + '" style="display: none" onclick="RADTranslationLine.clickSave(event)"/>'
	                        	 +'<img class="delete" src="' + SITE_URL + 'img/backend/icons/cross.png" width="16" height="16" border="0" alt="' + STR_DELETE + '" title="' + STR_DELETE + '" onclick="RADTranslationLine.clickDelete(event)"/>'
	                        	 +'</div>',
