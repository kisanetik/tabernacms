...
var MooTreeControl = new Class({
	...
	initialize: function(config, options) {
		...
		this.onLoadComplete = config.onLoadComplete || new Function();
...
var MooTreeNode = new Class({
	...
	initialize: function(options) {
		...
		this.div.gadget.onclick = this.div.gadget.ondblclick = function() { //this.div.gadget.ondblclick = 
			this._node.toggle();
		}
	...
	*/
	...
	_loaded: function(text, xml) {
		...
		this.control.enable();
		this.loading = false;
		this.control.onLoadComplete(this);
	},
