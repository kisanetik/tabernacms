 ...
 */
class controller_system_repository extends rad_controller
{
            ...
            switch($this->request('action')) {
                ...
                case 'getmod'://Gets the module
                    ...
                    if( (int)$this->request('i') ) {
                        $table = new model_system_table(RAD.'modules');
    ...
    */
    function validateXML() 
    {
        if($this->request('folder') and $this->request('fn')) {
            $model_params = rad_instances::get('model_system_params');
    ...
    function getLocalNodes()
    {
        ...
        if((int)$this->request('pid')) {
            $modules = rad_instances::get('model_system_aliases')->getIncludes(false,(int)$this->request('pid'));
            if(count($modules))
            ...
            $modules = rad_instances::get('model_system_aliases')->getModules();
