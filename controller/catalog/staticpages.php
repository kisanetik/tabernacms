 ...
 *
 */
class controller_catalog_staticpages extends rad_controller
{
    private $_pid = 18;
    ...
    function __construct()
    {
        ...
        if($this->_isshowpage) {
            ...
            $this->setVar('title', rad_instances::get('model_menus_tree')->getItem((int)$this->_assignRubric));
		}
    ...
    function assignRubrics(struct_pages $page)
    {
    ...
    function assignSuPages(struct_pages $page)
    {
    	$model = rad_instances::get('model_catalog_pages');
    	$model->clearState();
    ...
    function assignSuRubrics(struct_pages $page)
    {
      $model = rad_instances::get('model_menus_tree');
