 ...
 * @package Taberna
 */
class controller_session_loginpanel extends rad_controller
{
    ...
    {
        $items = rad_instances::get('model_catalog_currency')->getItems();
        $this->setVar('currency', $items);
        $this->setVar('currentCurrency', model_catalog_currcalc::getDefaultCurrencyId());
