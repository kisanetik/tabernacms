 ...
 * @package Taberna
 */
class controller_session_personalcabinet extends rad_controller
{
    ...
    function assignOrders()
    {
        ...
        if($pid>=0){
           $model->setState('pid',$pid);
            ...
            $item_tre = rad_instances::get('model_menus_tree')->getItem($this->_startType);
    ...
    function showRefStatistic()
    {
        ...
        $this->setVar('ref_link', model_session_referals::makeUrl($this->getCurrentUser()->u_id,
                        array('type'=>model_session_referals::TYPE_INDEX)));
        ...
        $model = rad_instances::get('model_session_referals')
