                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADArticlesTree.addClick();">
                                                    <img src="{const SITE_URL}img/backend/add.png" width="30" height="30" border="0" alt="{lang code='-add'|replace:'"':'&quot;'}" title="{lang code='-add'|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADArticlesTree.editClick();">
                                                    <img src="{const SITE_URL}img/backend/pencil.png" width="30" height="30" border="0" alt="{lang code='-edit'|replace:'"':'&quot;'}" title="{lang code='-edit'|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADArticlesTree.cancelEdit();">
                                                    <img class="img" src="{const SITE_URL}img/backend/arrow_undo.png" width="30" height="30" border="0" alt="{lang code='-cancel'|replace:'"':'&quot;'}" title="{lang code='-cancel'|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADArticlesTree.deleteNode();">
                                                    <img src="{const SITE_URL}img/backend/icons/ico_delete.gif" width="30" height="30" border="0" alt="{lang code='-delete'|replace:'"':'&quot;'}" title="{lang code='-delete'|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADArticlesTree.saveEdit();">
                                                    <img src="{const SITE_URL}img/backend/disk.png" width="30" height="30" border="0" alt="{lang code='-save'|replace:'"':'&quot;'}" title="{lang code='-save'|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADArticlesTree.editDetailClick();">
                                                    <img class="img" src="{const SITE_URL}img/backend/draw_points.png" alt="" width="30" height="30" border="0" alt="{lang code='editdetail.menus.button'|replace:'"':'&quot;'}" title="{lang code='editdetail.menus.button'|replace:'"':'&quot;'}" />
                                           ...
                                           <td height="100%" valign="bottom" nowrap="nowrap" width="250">
                                                <form method="post" id="searchArticlesForm" action="{const SITE_ALIAS}/action/search/" onsubmit="return false;">
                                                    <div>
                                                        ...
                                                        <div style="float:left;margin-top:5px;"><a><input type="image" src="{const SITE_URL}{const SITE_ALIAS}img/backend/zoom.png" alt="{$lang->_('submit')}" title="{$lang->_('submit')}"  onclick="RADArticles.searchClick();" /></a></div>
                                                    </div>
                                                </form>
                                           </td>
                                       </tr>
