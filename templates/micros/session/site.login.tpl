            ...
            <tr>
                ...
                <td align="left">
                    ...
                    {if $params->is_facebook}
                        <a href="javascript:RADSocials.socLogin('facebook');" style="text-decoration: none;"><img src="{const SITE_URL}img/des/default/socials/FaceBook_24x24.png" border="0" align="middle"/> <span style="font-size:13px;">Facebook</span></a>
                        <br/>
                    {/if}
                    {if $params->is_twitter}
                        <a href="javascript:RADSocials.socLogin('twitter');" style="text-decoration: none;"><img src="{const SITE_URL}img/des/default/socials/Twitter_24x24.png" border="0" align="middle"/> <span style="font-size:13px;">Twitter</span></a>
                    {/if}
                    </div>
                </td>
           </tr>
