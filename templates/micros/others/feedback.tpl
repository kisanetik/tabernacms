...
{else}
    <h2 style="padding: 0;text-align: center;padding-left:50px;margin-left:-50px;min-height:250px;background:#FFFFFF;position:absolute;top:70px;">{lang code="thainksfeedback.others.text" ucf=true}</h2>
{/if}
</span>
{/strip}