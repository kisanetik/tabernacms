...
<div class="cont">
	<form method="post" action="{url href="alias=search"}">
		<input type="text" name="search" maxlength="30" value="{if $search}{$search}{else}{lang code='phrase.search.text' ucf=true|replace:'"':'&quot;'}{/if}"
		   id="scan"
		{literal}
	...
	<a href="{const SITE_URL}"><img src="{const SITE_URL}img/des/default/logo.jpg" width="144" height="40"
									title="TABERNA" class="site_logo"/></a>
