                ...
                <tr>
                    ...
                    <td align="left" id="lang_tree" class="tree" onclick="RADLanguagesPanel.deselect()">
                        ...
                        <div class="element" onclick="RADLanguagesPanel.select(this, event)">
                            <div class="flag">
                                <img src="{const SITE_URL}image.php?f={$language->lng_img}&w=32&h=32&m=lang" border="0"/>
                            </div>
            ...
            <table class="tb_cont_block" style="height:auto;width:600px;display:none;" id="editCatTreeBlock">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADLangPropertiesPanel.applyLanguage();">
                                                    <img src="{const SITE_URL}img/backend/accept.png" width="30" height="30" border="0" alt="{lang code='-apply'}" title="{lang code='-apply'}" />
                ...
                <tr>
                    ...
                    <td class="tb_bottom" style="border: 1px solid #ccc;height: 223px; text-align: center; vertical-align: middle;">
                        <img id="language_details_preloader" src="{const SITE_URL}jscss/components/mootree/mootree_loader.gif" width="18" height="18" style="display:none" />
                                                ...
                                                <tr align="center">
                                                    ...
                                                    <td style="vertical-align: top; width: 40px">
                                                        <a href="javascript:void(0)" onclick="RADLangPropertiesPanel.clearPreviewFlagImage()" title="Удалить изображение" id="language_details_preview_clear" style="display: none">
                                                            <img src="{const SITE_URL}img/backend/icons/cross.png" width="16" height="16" border="0"/>
                                                        </a>
                                                    </td>
                                        ...
                                        <tbody><tr>
                                            <td>
                                                <a href="javascript:RADTranslationsPanel.clickRefresh();">
                                                    <img width="30" height="30" border="0" title="{lang code='-refresh'}" alt="{lang code='-refresh'}" src="{const SITE_URL}img/backend/arrow_refresh.png">
                                        ...
                                        <tbody><tr>
                                            <td>
                                                <a href="javascript:RADTranslationsPanel.clickSaveAll();">
                                                    <img width="30" height="30" border="0" title="{lang code='-save'}" alt="{lang code='-save'}" src="{const SITE_URL}img/backend/disk_multiple.png">
                                        ...
                                        <tbody><tr>
                                            <td>
                                                <a href="javascript:RADTranslationsPanel.clickAddTranslation()" id="addBtn">
                                                    <img width="30" height="30" border="0" title="{lang code='-add'}" alt="{lang code='-add'}" src="{const SITE_URL}img/backend/add.png">
                                           ...
                                           <td width="250" valign="bottom" nowrap="nowrap" height="100%">
                                                <div>
                                                    ...
                                                    <div style="float:left;margin-top:2px;margin-left:5px;">
                                                        <input type="image" onclick="RADTranslationsPanel.filterApply();" title="{lang code='-find'}" alt="{lang code='-find'}" src="{const SITE_URL}img/backend/zoom.png">
                                                    </div>
                                                </div>
                                           </td>
                            ...
                            <tr class="translation_new" style="display: none">
                                ...
                                <td width="5%" style="text-align: center">
                                    <div id="translation_new_save" style="display: none">
                                        <img src="{const SITE_URL}img/backend/icons/disk.png"
...
<!--
<img border="0" title="{lang code='-save' ucf=true}" alt="{lang code='-save' ucf=true}" src="{const SITE_URL}img/backend/icons/disk.png">
<img border="0" title="{lang code='-delete' ucf=true}" alt="{lang code='-delete' ucf=true}" src="{const SITE_URL}img/backend/icons/cross.png">
-->
{/strip}