                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            ...
                            <td nowrap="nowrap">
                                {if !$id->is_ga}
                                    {if $id->hasOptions}
                                    <a href="javascript:RADIncInAlAction.configOneClick('{$id->incinal_id}');"><img src="{const SITE_URL}img/backend/icons/setting_tools.png" alt="{lang code='-config' ucf=true|replace:'"':'&quot;'}" width="17" height="17" border="0"></a>
                                    {/if}
                                    <a href="javascript:RADIncInAlAction.deleteOneClick('{$id->incinal_id}');"><img src="{const SITE_URL}img/backend/icons/cross.png" alt="{lang code="-delete" ucf=true|replace:'"':'&quot;'}" width="17" height="17" border="0"></a>
                                {/if}
                            </td>
                        </tr>
                    </table>
