                                        ...
                                        <tr>
                                            <td>
                                                <a href="{url href="alias=SITE_ALIAS"}">
                                                    <img class="img" src="{const SITE_URL}img/backend/cross.png" alt="{lang code='-cancel' ucf=true|replace:'"':'&quot;'}" title="{lang code='-cancel' ucf=true|replace:'"':'&quot;'}" width="30" height="30" border="0">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADAliasesAction.applyClick('{$item->id}');">
                                                    <img src="{const SITE_URL}img/backend/accept.png" alt="{lang code='-apply' ucf=true|replace:'"':'&quot;'}" title="{lang code='-apply' ucf=true|replace:'"':'&quot;'}" width="30" height="30" border="0">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADAliasesAction.saveClick('{$item->id}');">
                                                    <img src="{const SITE_URL}img/backend/disk.png" alt="{lang code='-save' ucf=true|replace:'"':'&quot;'}" title="{lang code='-save' ucf=true|replace:'"':'&quot;'}" width="30" height="30" border="0">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADScriptWindow.aliasScriptShow('{$item->id}');">
                                                    <img src="{const SITE_URL}img/backend/alias_script.gif" alt="{lang code='metatags.system.button' ucf=true|replace:'"':'&quot;'}" title="{lang code='metatags.system.button' ucf=true|replace:'"':'&quot;'}" width="30" height="30" border="0">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADAliDescr.show('{$item->id}');">
                                                    <img src="{const SITE_URL}img/backend/alias_script.gif" alt="{lang code='description.system.button' ucf=true|replace:'"':'&quot;'}" title="{lang code='description.system.button' ucf=true|replace:'"':'&quot;'}" width="30" height="30" border="0">
                    ...
                    <td align="left">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="tb_list" id="tb_list">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{const SITE_URL}img/backend/icons/accept.png" alt="{lang code='-yes' ucf=true|replace:'"':'&quot;'}" title="{lang code='-yes' ucf=true|replace:'"':'&quot;'}" border="0" />
                                </td>
                                <td>
                                    <a href="javascript:ThemeRules.edit({$item->id},'');"><img src="{const SITE_URL}img/backend/icons/page_edit.png" alt="{lang code='-edit' ucf=true|replace:'"':'&quot;'}" title="{lang code='-edit' ucf=true|replace:'"':'&quot;'}" border="0" /></a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {foreach from=$themes_rules item=theme_rule}
                                       ...
                                       {/if}
                                    {/foreach}
                                    <img id="theme_ex_t_{$theme}" {if !$rule_exist}style="display:none;"{/if} src="{const SITE_URL}img/backend/icons/accept.png" alt="{lang code='-yes' ucf=true|replace:'"':'&quot;'}" title="{lang code='-yes' ucf=true|replace:'"':'&quot;'}" border="0" />
                                </td>
                                <td>
                                    <a id="theme_hrf_add_{$theme}" {if $rule_exist}style="display:none;"{/if} href="javascript:ThemeRules.create({$item->id},'{$theme}');"><img src="{const SITE_URL}img/backend/icons/page_add.png" alt="{lang code='-edit' ucf=true|replace:'"':'&quot;'}" title="{lang code='-edit' ucf=true|replace:'"':'&quot;'}" border="0" /></a>
                                    <a id="theme_hrf_edit_{$theme}" {if !$rule_exist}style="display:none;"{/if} href="javascript:ThemeRules.edit({$item->id},'{$theme}');"><img src="{const SITE_URL}img/backend/icons/page_edit.png" alt="{lang code='-edit' ucf=true|replace:'"':'&quot;'}" title="{lang code='-edit' ucf=true|replace:'"':'&quot;'}" border="0" /></a>
                                    <a id="theme_hrf_del_{$theme}" {if !$rule_exist}style="display:none;"{/if} href="javascript:ThemeRules.delete({$item->id},'{$theme}');"><img src="{const SITE_URL}img/backend/icons/cross.png" alt="{lang code='-delete' ucf=true|replace:'"':'&quot;'}" title="{lang code='-delete' ucf=true|replace:'"':'&quot;'}" border="0" /></a>
                                </td>
                            </tr>
                            {/foreach}
                        </table>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADIncInAlAction.deleteClick();">
                                                    <img src="{const SITE_URL}img/backend/icons/ico_delete.gif" alt="{lang code='-delete' ucf=true|replace:'"':'&quot;'}" title="{lang code='-delete' ucf=true|replace:'"':'&quot;'}" width="30" height="30" border="0">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADIncInAlAction.addClick();">
                                                    <img src="{const SITE_URL}img/backend/add.png" alt="{lang code='-add' ucf=true|replace:'"':'&quot;'}" title="{lang code='-add' ucf=true|replace:'"':'&quot;'}" width="30" height="30" border="0">
