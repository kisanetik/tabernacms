                                       ...
                                       <tr>
                                           <td height="100%" valign="bottom" nowrap="nowrap" width="250">
                                                <div>
                                                    ...
                                                    <div style="float:left;">
                                                        <a>
                                                            <input type="image" src="{const SITE_URL}img/backend/zoom.png" alt="{lang code='-submit' ucf=true|replace:'"':'&quot;'}" title="{lang code='-search.title' ucf=true|replace:'"':'&quot;'}" onclick="RADAliasesList.search();" />
                                                        </a>
                                                    </div>
                                                </div>
                                           </td>
