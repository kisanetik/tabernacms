                    ...
                    <div class="tb_line_ico">
                        ...
                        <tr>
                            ...
                            <a href="javascript:RADAddEditProduct.cancelClick();">
                                <img src="{const SITE_URL}img/backend/arrow_undo.png" width="33" height="33" border="0" class="img" alt="{lang code='-cancel' ucf=true|replace:'"':'&quot;'}" title="{lang code='-cancel'|replace:'"':'&quot;'}" />
                        ...
                        {if ($cat_id)}
                            ...
                            <tr>
                                ...
                                <a href="{url href="action=deleteproductnojs&cat_id=`$cat_id`&hash=`$hash`"}" onclick="return RADAddEditProduct.deleteClick(this)">
                                    <img src="{const SITE_URL}img/backend/icons/ico_delete.gif" width="33" height="33" border="0" class="img" alt="{lang code="-delete" ucf=true|replace:'"':'&quot;'}" />
                        ...
                        <table class="item_ico">
                            <tr>
                                ...
                                <a href="javascript:RADAddEditProduct.applyClick();">
                                    <img src="{const SITE_URL}img/backend/accept.png" width="33" height="33" border="0" class="img" alt="{lang code='-apply'|replace:'"':'&quot;'}" title="{lang code='-apply'|replace:'"':'&quot;'}" />
                        ...
                        <table class="item_ico">
                            <tr>
                                ...
                                <a href="javascript:RADAddEditProduct.saveClick();">
                                    <img src="{const SITE_URL}img/backend/disk.png" width="33" height="33" border="0" class="img" alt="{lang code='-save' ucf=true|replace:'"':'&quot;'}" title="{lang code='-save'|replace:'"':'&quot;'}" />
                                        ...
                                        <div id="tables_images">
                                            ...
                                            {if count($product->images_link)}
                                                ...
                                                <div id="img_cat_{$img_item->img_id}">
                                                    ...
                                                    <br />
                                                    <label>
                                                        <input type="checkbox" id="del_img_{$img_item->img_id}" name="del_img[{$img_item->img_id}]" />&nbsp;
                                        ...
                                        <div id="tables_3dimages"{if !$license_3dbin} style="display:none;{/if}">
                                            <div id="load_3d_bar" style="position:absolute;z-index:1000;width:100%;height:100%;background:white;display:none;">
                                                <div style="position:absolute;left:45%;top:40%;">
                                                    ...
                                                    <img id="load_3d_pb" src="{const SITE_URL}jscss/components/fileuploader/loader.gif" style="width:150px;"/>
                                                </div>
                                            </div>
                                            {url file="jscss/components/fileuploader/image_uploader.css" type="css" param="link"}
                                            {url file="jscss/components/fileuploader/moouploader.js" type="js"}
