...
{if !empty($items_3dbin)}
    {foreach $items_3dbin as $item}
        <hr />
        <div class="3ditem">
            <object type="application/x-shockwave-flash" data="{url file=$item->img_filename type="dfile" module="3dbin"}" width="530" height="400" id="intro_swf_example" style="visibility: visible; ">
	        </object>
	        <br />
	        <label>
