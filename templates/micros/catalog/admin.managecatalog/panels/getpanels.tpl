                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADCatalogTree.cancelEdit();">
                                                    <img class="img" src="{const SITE_URL}img/backend/arrow_undo.png" width="30" height="30" border="0" alt="{lang code='-cancel'}" title="{lang code='-cancel' ucf=true|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADCatalogTree.deleteNode();">
                                                    <img src="{const SITE_URL}img/backend/icons/ico_delete.gif" width="30" height="30" border="0" alt="{lang code='-delete'}" title="{lang code='-delete' ucf=true|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADCatalogTree.applyEdit();">
                                                    <img src="{const SITE_URL}img/backend/accept.png" width="30" height="30" border="0" alt="{lang code='-apply'}" title="{lang code='-apply' ucf=true|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADCatalogTree.submitEdit();">
                                                    <img src="{const SITE_URL}img/backend/disk.png" width="30" height="30" border="0" alt="{lang code='-save'}" title="{lang code='-save' ucf=true|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADCatalogTree.editDetailClick();">
                                                    <img class="img" src="{const SITE_URL}img/backend/draw_points.png" width="30" height="30" border="0" alt="{lang code='editdetail.menus.button'}" title="{lang code='editdetail.menus.button' ucf=true|replace:'"':'&quot;'}" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javascript:RADCatalogList.add(0);">
                                                    <img src="{const SITE_URL}img/backend/add.png" width="30" height="30" border="0" alt="{lang code='-add'}" title="{lang code='-add' ucf=true|replace:'"':'&quot;'}" />
                                                    <span class="text" style="width:50px;">{lang code='-add' ucf=true}</span>
                                                </a>
                                            </td>
                                        </tr>
                                                ...
                                                <form method="post" id="searchProductsForm" action="{url href="action=search"}" onsubmit="return false;">
                                                    <div>
                                                        ...
                                                        <div style="float:left;margin-top:14px;">
                                                            <a>
                                                                <input type="image" src="{const SITE_URL}img/backend/zoom.png" alt="{lang code='-submit' ucf=true|replace:'"':'&quot;'}" title="{lang code='-submit' ucf=true|replace:'"':'&quot;'}"  onclick="RADCatalogList.search();" />
                                                            </a>
                                                        </div>
                                                    </div>
                                                </form>
