                                           ...
                                           <td height="100%" valign="bottom" nowrap="nowrap" width="250">
                                                <form method="post" id="searchNewsForm" action="{const SITE_URL}{const SITE_ALIAS}/action/search/" onsubmit="return false;">
                                                    <div>
                                                        ...
                                                        <div style="float:left;margin-top:5px;"><a><input type="image" src="{const SITE_URL}img/backend/zoom.png" alt="{$lang->_('submit')}" title="{$lang->_('submit')}"  onclick="RADNews.searchClick();" /></a></div>
                                                    </div>
                                                </form>
                                           </td>
                                       </tr>
