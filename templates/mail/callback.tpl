...
{strip}
    ...
    *}
    {mailtemplate type="html" name="from"}
		{lang code="callback.mailtemplate.title" ucf=true} <{config get="system.mail"}>
    {/mailtemplate}
    ...
    *}
    {mailtemplate type="html" name="subject"}
        {lang code="callback.mail.title" ucf=true}
    {/mailtemplate}
    ...
    *}
    ...
    <html>
        <head>
            <title>{lang code="callback.mail.title" ucf=true}</title>
        </head>
        <body>
			{lang code="new_message.callback.mail.message" ucf=true}<br/>
            {$fio} - {$phone}
        </body>
    </html>
    {/mailtemplate}
...
{literal}
{lang code="callback.mail.title" ucf=true}
{lang code="new_message.callback.mail.message" ucf=true}
{$fio} - {$phone}
{/literal}
    {/mailtemplate}
{/strip}