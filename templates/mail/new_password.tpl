...
{strip}
    ...
    *}
    ...
    <html>
        ...
        <body>
            Данные для авторизации на Вашем аккаунте обновлены: <a href="{const SITE_URL}">{const SITE_URL}</a> 
            <br />
            E-Mail: {$user->u_email}
            <br />
            Пароль: {$clearpass}
...
{literal}
{lang code="rempass.mail.title" ucf=true}
Данные для авторизации на Вашем аккаунте обновлены: {config SITE_URL}
E-Mail: {$user->u_email}
Пароль: {$clearpass}
{/literal}
    {/mailtemplate}
